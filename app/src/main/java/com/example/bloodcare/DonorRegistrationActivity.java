...
public class DonorRegistrationActivity extends AppCompatActivity {
    ...
    private EditText registerFullName2,registerIdNumber2, registerPhoneNumber2, registerEmail2, registerPassword2;

    private Spinner bloodGroupsSpinner2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerButton2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                final String email = registerEmail2.getText().toString().trim();
                final String password = registerPassword2.getText().toString().trim();
                final String fullName = registerFullName2.getText().toString().trim();
                final String idNumber = registerIdNumber2.getText().toString().trim();
                final String phoneNumber = registerPhoneNumber2.getText().toString().trim();
                final String bloodGroup = bloodGroupsSpinner2.getSelectedItem().toString();

                if (TextUtils.isEmpty(email)){
                    registerEmail2.setError("Email is required!");
                    return;
                }
                if (TextUtils.isEmpty(password)){
                    registerPassword2.setError("Password is required!");
                    return;
                }
                if (TextUtils.isEmpty(fullName)){
                    registerFullName2.setError("Full Name is required!");
                    return;
                }
                if (TextUtils.isEmpty(idNumber)){
                    registerIdNumber2.setError("Aadhaar Number is required!");
                    return;
                }
                if (TextUtils.isEmpty(phoneNumber)){
                    registerPhoneNumber2.setError("Phone Number is required!");
                    return;
                }
